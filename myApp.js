...
var createAndSavePerson = function(done) {
  var ObinnaEkwuno = new Person({name: "Obinna Ekwuno", age: 23, favoriteFoods: ["jollof", "pancakes"]});

  ObinnaEkwuno.save(function(err, data) {
...
var arrayOfPeople = [
  {name: "Lucy", age: 74, favoriteFoods: ["Githeri Taco"]},
  {name: "Tracy", age: 76, favoriteFoods: ["roast chicken"]},
  {name: "Jemmy", age: 78, favoriteFoods: ["pilau"]}
];
